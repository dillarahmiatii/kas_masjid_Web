...
<head>
	...
	<title>Masjid Azharul Iman</title>
	<link rel="icon" href="dist/img/logo_masjid.png">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_km" class="nav-link">Data Keuangan Kas Masjid</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_ks" class="nav-link">Data Keuangan Kas Anak Yatim</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="http://localhost/kas_masjid/" class="brand-link">
				<img src="dist/img/logo_masjid.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> Masjid Azharul Iman</span>
			</a>
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="?page=i_data_ks" class="nav-link">
										<i class="nav-icon far fa-circle text-success"></i>
										<p>Pemasukan Kas Anak Yatim</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=o_data_ks" class="nav-link">
										<i class="nav-icon far fa-circle text-danger"></i>
										<p>Pengeluaran Kas Anak Yatim</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=rekap_ks" class="nav-link">
										<i class="nav-icon far fa-circle text-primary"></i>
										<p>Rekapitulasi Kas Anak Yatim</p>
									</a>
								</li>
							</ul>
						</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              ...
              case 'lap_masjid':
                  ...
                  break;
              case 'lap_sosial':
                  include "bendahara/masjid/laporan/lap_sos.php";
                  break;
